...
final class OpenAIScriptGenerator implements ScriptGenerator
{
    ...
    public function generate(?string $prompt = null): string
    {
        ...
        $systemPrompt = 'You are an expert scriptwriter for AI-generated videos. Your task is to generate creative, engaging, and well-structured scripts that work perfectly for video generation with OpenAI Sora-2.
