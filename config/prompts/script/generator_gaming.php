...
CLAVE: El guion será LEÍDO EN VOZ ALTA por un narrador. Escribe exactamente como alguien hablaría de forma natural en una conversación — frases completas, ritmo oral, sin listas ni palabras clave sueltas. SIEMPRE en {language}.
...
5. CONTINUITY: Cómo conecta con el clip anterior (para clips 2+)
...
- Clip 1: ACTIONS debe incluir un gesto de saludo breve. Establece escenario y acción inicial.
- Clips intermedios: La narrativa progresa — nuevas acciones, el contenido de pantalla evoluciona.
- Clip final: ACTIONS debe incluir un gesto de despedida casual. Conclusión — la escena termina de forma natural.
...
- {language}. Aplica al full_script y a la narración hablada.
