...
- Que la escena es un plató de TV profesional con una pantalla LED que muestra un mapa de España
...

{
  ...
  "clip_prompts": [
    ...
    "CONTEXT: Previsión meteorológica diaria para ciudades españolas. Este clip cubre Barcelona (noreste de España). Plató de televisión profesional con pantalla LED que muestra un mapa de España. La presentadora — misma persona que en la imagen de referencia, mismo aspecto y vestimenta — hace la transición de Madrid a Barcelona. ACTION: La presentadora barre con la mano desde el centro hacia la esquina superior derecha de la pantalla LED, señalando la posición de Barcelona en el mapa. CINEMATOGRAPHY: Medium shot, gentle lateral dolly right. Presenter camera-left, framing adjusts as she gestures toward the screen. Static base with subtle lateral movement. DIALOGUE: The presenter says: \"Si nos vamos a Barcelona, la cosa cambia bastante. Allí los cielos van a estar nubosos durante buena parte del día, con temperaturas entre los ocho y los catorce grados, y ojo porque por la tarde hay un cuarenta por ciento de probabilidad de chubascos. Así que si salís, llevaos un paraguas por si acaso.\" STYLE & AMBIANCE: Warm broadcast studio lighting, even and diffused. Quiet studio ambient with subtle room tone. Photorealistic national television quality.",
    "CONTEXT: Previsión meteorológica diaria para ciudades españolas. Este clip cubre Sevilla y Málaga (sur de España). Plató de televisión profesional con pantalla LED que muestra un mapa de España. La presentadora — misma persona que en la imagen de referencia, mismo aspecto y vestimenta — transiciona desde Barcelona hacia el sur del país y cierra la previsión. ACTION: La presentadora barre con la mano en diagonal descendente desde la esquina superior derecha hacia la zona inferior izquierda de la pantalla LED, señalando Sevilla en el mapa, y luego hace un gesto corto hacia la derecha para indicar Málaga. Termina con un gesto de despedida casual mirando a cámara. CINEMATOGRAPHY: Medium close-up, subtle pull-back to medium shot as she gestures across the screen. Presenter camera-right, rule of thirds. Static base with gentle widening. DIALOGUE: The presenter says: \"Y si bajamos al sur, en Sevilla tenemos un día espléndido, con sol y máximas de veintidós grados, perfecto para pasear. En Málaga, algo más de nubes, pero con temperaturas muy agradables entre los catorce y los veinte grados. Eso es todo por hoy, pasad buen día y nos vemos mañana.\" STYLE & AMBIANCE: Warm broadcast studio lighting, even and diffused. Quiet studio ambient with subtle room tone. Photorealistic national television quality."
  ]
}
"""
PROMPT,
