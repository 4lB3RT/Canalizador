...
IDIOMA:
OBLIGATORIO: Generar título y descripción en {language}. Usar un registro natural y nativo de ese idioma.
...
- La descripción debe tener entre 200 y 250 caracteres (estrictamente obligatorio)
...
- La descripción debe estar en {language}
...
- Tanto el título como la descripción deben estar en {language}
PROMPT,
];
